...
public class Test : MonoBehaviour {
	void Update () {
		...
		if (UnityPitchControl.Input.InputManager.GetKey(KeyCode.B)) {
			Debug.Log("'b' down");
		}
		if (UnityPitchControl.Input.InputManager.GetKey(KeyCode.C)) {
			Debug.Log("'c' down");
		}
		if (UnityPitchControl.Input.InputManager.GetKey(KeyCode.D)) {
			Debug.Log("'d' down");
		}
